...
const TOKEN_DIR = __dirname + '/.credentials/'; //the directory where we're going to save the token
const TOKEN_PATH = TOKEN_DIR + 'sheets.googleapis.com-nodejs-token.json'; //the file which will contain the token
...
class Authentication {
    ...
    getClientSecret() {
        return require('../client_secret2.json');
    }
